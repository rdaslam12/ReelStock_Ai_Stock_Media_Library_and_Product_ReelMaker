...
Orchestrates the complete product variation pipeline:
  ...
  2. Generate 5 empty studio background plates (HF FLUX or premium local fallback)
...
Returns 6 frame paths:
  ...
  • Frames 1–5 — product composited onto empty studio plates
...
def generate_variations(
    ...
    logger.info(f"variation_generator [{run_id}]: generating empty {category} studio background plates")
